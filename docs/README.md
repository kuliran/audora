...
- **[Local setup with Codex + Parakeet](./LOCAL_CODEX_SETUP.md)** - Two-script bootstrap and foreground launcher for local JWT, Convex, Codex coaching, and macOS transcription
